...
using sisedimodel;
using sisedicontroller;

namespace sisediview
{
    public class menuPrincipal
    {
        ...
        public void exibirSubMenuEditoras()
        {
            int opcsub = 0;
            // Menu Editoras
            while (opcsub != 19)
        ...
        public void exibirSubMenuLivros()
        {
            int opcsub = 0;
            // Menu Livros
            while (opcsub != 19)
        ...
        public void exibirSubMenuAutores()
        {
            int opcsub = 0;
            // Menu Autores
            while (opcsub != 19)
